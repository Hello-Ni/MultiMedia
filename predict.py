...
if __name__ == "__main__":
    if len(sys.argv) <= 1:
        print("Please enter the file name of the song")
        exit()
    ...
    for i in range(0, parts):
        ...
        for n in range(num_segment):
            ...
            mfcc = librosa.feature.mfcc(
                y[start:finish], sample_rate, n_mfcc=num_mfcc, n_fft=n_fft, hop_length=hop_length)
            mfcc = mfcc.T
            # print(mfcc.shape)
    ...
    print("The genres of the song is:"+prediction)
